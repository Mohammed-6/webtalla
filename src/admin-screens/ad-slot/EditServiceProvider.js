...
const EditServiceProvider = props => {
  ...
  const addProvider = () => {
    ...
    create
      .post(
        process.env.REACT_APP_BASEURL + "adslots/update_provider?id=" + editid,
        formData,
        {
          headers: {
      ...
      <div className="inner-repeater mb-4">
        ...
        <table style={{ width: "100%" }}>
          <tbody>
            ...
            {rows1.map((item1, idx) => {
              let dd = parseInt(idx) + parseInt(2) + parseInt(editdata.length)
              return (
                    ...
                    <Row className="inner mb-3">
                      <Col md="9" className="col-8">
                        <Input
                          ...
                          className="inner form-control"
                          placeholder={
                            "Description... " + (idx + 2 + editdata.length)
                          }
                          onChange={e =>
                            changeDescription(e, idx + 2 + editdata.length)
                          }
                        />
                      </Col>
                      <Col md="3" className="col-4">
                        <Button
                          onClick={e =>
                            handleRemoveRowNested(e, idx + 2 + editdata.length)
                          }
                          color="primary"
                          className="btn-block inner"
                          style={{ width: "100%" }}
      ...
      <div className="inner-repeater mb-4">
        ...
        <table style={{ width: "100%" }}>
          <tbody>
                      ...
                      <Row className="inner mb-3">
                        <Col md="9" className="col-8">
                          <textarea
                            ...
                            className="inner form-control"
                            placeholder={"Description... " + idx}
                            onChange={e => changeDescription1(e, idx)}
                            defaultValue={desc}
                          ></textarea>
                        </Col>
                        <Col md="3" className="col-4">
                          <Button
                            onClick={e => handleRemoveRowNested1(e, idx)}
                            color="primary"
                            className="btn-block inner"
                            style={{ width: "100%" }}
                          >
            ...
            {rows2.map((item1, idx) => {
              let dd = parseInt(idx) + parseInt(2) + parseInt(editdata1.length)
              return (
                    ...
                    <Row className="inner mb-3">
                      <Col md="9" className="col-8">
                        <textarea
                          ...
                          className="inner form-control"
                          placeholder={
                            "Description... " + (idx + 2 + editdata1.length)
                          }
                          onChange={e =>
                            changeDescription1(e, idx + 2 + editdata1.length)
                          }
                        />
                      </Col>
                      <Col md="3" className="col-4">
      ...
      <div className="inner-repeater mb-4">
        ...
        <table style={{ width: "100%" }}>
          <tbody>
                      ...
                      <Row className="inner mb-3">
                        <Col md="9" className="col-8">
                          <textarea
                            ...
                            className="inner form-control"
                            placeholder={"Description... " + idx}
                            onChange={e => changeDescription2(e, idx)}
                            defaultValue={desc}
                          ></textarea>
                        </Col>
                        <Col md="3" className="col-4">
                          <Button
                            onClick={e => handleRemoveRowNested2(e, idx)}
                            color="primary"
                            className="btn-block inner"
                            style={{ width: "100%" }}
                          >
            ...
            {rows3.map((item1, idx) => {
              let dd = parseInt(idx) + parseInt(2) + parseInt(editdata2.length)
              return (
                    ...
                    <Row className="inner mb-3">
                      <Col md="9" className="col-8">
                        <textarea
                          ...
                          className="inner form-control"
                          placeholder={
                            "Description... " + (idx + 2 + editdata2.length)
                          }
                          onChange={e =>
                            changeDescription2(e, idx + 2 + editdata2.length)
                          }
                        />
                      </Col>
                      <Col md="3" className="col-4">
