...
const tawkToPropertyId = "611a7d73d6e7610a49b06fee"
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 footer-column">
              <div class="logo-wideget footer-wideget">
                <div class="footer-logo">
                  <a href="index.php">
                    {" "}
                    {/* <img src={Logo} class="logo1" height="100" /> */}
                  </a>
                </div>
                <div class="text">
                  <p align="justify">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 footer-column">
              <div class="service-wideget footer-wideget">
                ...
                <ul className="no-bullets site-footer">
                  ...
                  <li>
                    <Link to="/platform-policy">Platform Policy</Link>
                  </li>
                  ...
                  <div class="single-item">
                    ...
                    <div class="text">
                      <p>
                        ...
                        Industry,
                        <br /> Herbert Macaulay way,
                        <br /> Central Business District FCT, Abuja
                      </p>
                    </div>
                  </div>
                  <div class="single-item">
